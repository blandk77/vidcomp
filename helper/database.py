...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @the_tgguy" -metadata author="me" -metadata:s:s title="Subtitles" -metadata:s:a title="By :- @the_tgguy" -metadata:s:v title="◉⁠‿⁠◉" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
